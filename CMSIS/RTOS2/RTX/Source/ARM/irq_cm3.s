...
Fault_Handler\
                ...
                STR      R2,[R1],#4               ; Store it in osRtxFaultContext.R0 and increment R1 by 4
                LDR      R2,[R0,#4]               ; Capture R1
                STR      R2,[R1],#4               ; Store it in osRtxFaultContext.R1 and increment R1 by 4
                LDR      R2,[R0,#8]               ; Capture R2
                STR      R2,[R1],#4               ; Store it in osRtxFaultContext.R2 and increment R1 by 4
                LDR      R2,[R0,#12]              ; Capture R3
                STR      R2,[R1],#4               ; Store it in osRtxFaultContext.R3 and increment R1 by 4
                STMIA    R1!,{R4-R11}             ; Capture R4..R11 and store it in osRtxFaultContext.R4..R11 and update R1
                LDR      R2,[R0,#16]              ; Capture R12
                STR      R2,[R1],#4               ; Store it in osRtxFaultContext.R12 and increment R1 by 4
